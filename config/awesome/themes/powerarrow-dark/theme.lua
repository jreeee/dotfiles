...
theme.bg_normal                                 = "#1A1A1A5A" -- custom
theme.bg_focus                                  = "#3A3A3A5A" -- custom  
theme.bg_urgent                                 = "#9c33333A" -- custom
theme.border_width                              = dpi(1)
theme.border_normal 							= "#35455A" -- color10
theme.border_focus 								= "#EDC376" -- color14
